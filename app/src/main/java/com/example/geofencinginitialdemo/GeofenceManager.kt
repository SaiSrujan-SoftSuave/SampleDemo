...
import com.example.geofencinginitialdemo.Utlis.CUSTOM_REQUEST_CODE_GEOFENCE
...
class GeofenceManager(context: Context) {
    ...
    fun addGeofence(
        ...
        Log.d("GeofenceManager", "addGeofence:${geofenceList[key]} and key: ${key}")
    }
    ...
    suspend fun deregisterGeofence() = kotlin.run {
        await(client.removeGeofences(geofencingPendingIntent))
        geofenceList.clear()
    }
